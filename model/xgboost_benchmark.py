...
# Plot predictions using the same function from the neural network code
def plot_predictions(predictions, actuals, model_name):
    ...
    fig.write_image(f'/Github/DeepLforConcreteReuse/Model/{model_name}_predictions.png')
...
def compare_models(nn_predictions, xgb_predictions, actuals):
    ...
    # Save the figure (optional)
    fig.write_image('/Github/DeepLforConcreteReuse/Model/model_comparison.png')
