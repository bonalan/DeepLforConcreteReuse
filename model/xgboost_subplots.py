...
# Load your neural network model and generate predictions
print("Loading Neural Network model and generating predictions...")
model = load_model('/Users/boenalan/Library/CloudStorage/GoogleDrive-boenalan@ethz.ch/My Drive/CEA/PhD/ACADIA24/TAD/Peer Review/Model/model.keras')
...
journal_fig.write_image(
    '/Users/boenalan/Library/CloudStorage/GoogleDrive-boenalan@ethz.ch/My Drive/CEA/PhD/ACADIA24/TAD/journal_landscape_comparison.png',
    width=1600, 
    height=800, 
...
journal_fig.write_image(
    '/Users/boenalan/Library/CloudStorage/GoogleDrive-boenalan@ethz.ch/My Drive/CEA/PhD/ACADIA24/TAD/journal_landscape_comparison.pdf',
    width=1600, 
    height=800
)
